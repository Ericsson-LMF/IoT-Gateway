...
public enum JavaHelper {
     ...
     * @param source origin of information that code has been generated from
     * @return warning
     */
    public static String getGenerationWarning(Class<?> generator, String source) {
        String result = "THIS IS AUTOMATICALLY GENERATED BY {@link " + generator.getCanonicalName() + "}.";
        if (source == null || source.isEmpty()) {
            return result;
        }
        return result + " Generated according " + source + ".";
    }
